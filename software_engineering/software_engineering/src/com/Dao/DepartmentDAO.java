...
public class DepartmentDAO extends BaseHibernateDAO {
	...
	// property constants
	public static final String DEPARTMENT_TITLE = "departmentTitle";
	...
	public List findByExample(Department instance) {
		...
		try {
			List results = getSession().createCriteria("com.Dao.Department")
	...
	public List findByDepartmentTitle(Object departmentTitle) {
		return findByProperty(DEPARTMENT_TITLE, departmentTitle);
	}
