...
public class EmployeeDAO extends BaseHibernateDAO {
	...
	public Employee findById(java.lang.Integer id) {
		...
		try {
			Employee instance = (Employee) getSession().get("com.Model.Employee",
					id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Employee instance) {
		...
		try {
			List results = getSession().createCriteria("com.Dao.Employee")
	...
	public List findByHireDate(Object hireDate) {
		return findByProperty(HIRE_DATE, hireDate);
	}
